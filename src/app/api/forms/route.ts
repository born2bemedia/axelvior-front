                ...
                <table role="presentation"
                    ...
                    <tr>
                        <td style="padding: 0;height: 100px;">
                            ...
                            <img style="width: 100%;height: auto;" src="https://axelvior .com/images/mail-header.png"
                                alt="axelvior  Logo">
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="border-top: 1px solid #222; padding: 24px 30px; background: #000;">
                            <a href="mailto:info@axelvior .com" style="color: #FFF;
                            font-size: 10px;
                            font-style: normal;
                            font-weight: 400;
                            line-height: normal;
                            ...
                            text-decoration: none;">
                                <img style="margin-right: 8px;margin-bottom: -2px;" width="14" height="14"
                                    src="https://axelvior .com/images/mail-icon.png" alt="axelvior  Mail Icon">
                                info@axelvior .com
                            </a>
                            <img style="width: 124.695px;height: 20px; float: right;"
                                src="https://axelvior .com/images/mail-logo.png" alt="axelvior  Mail Icon">
                        </td>
                    </tr>
                </table>
            </td>
                ...
                <table role="presentation"
                    ...
                    <tr>
                        <td style="padding: 32px;background: #000;">
                            ...
                            font-weight: 300;
                            line-height: normal;">
                                Thank you for choosing <b>axelvior </b> for your real estate consultation.
                            </p>
                            ...
                            font-weight: 300;
                            line-height: normal;">
                                We appreciate your trust in axelvior  and look forward to working with you.
                            </p>
