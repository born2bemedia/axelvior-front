...
const imgBusinessVerification =
  "/images/home/imgBusinessVerification.svg";
const imgKybRating =
  "/images/home/imgKybRating.svg";
const imgIndustryPrediction =
  "/images/home/imgIndustryPrediction.svg";
const imgConsumerSolutions =
  "/images/home/imgConsumerSolutions.svg";
const imgBannerBg =
  "/images/home/imgBannerBg.png";
      ...
      <div className="container">
        <div className={styles.home_who__inner}>
          ...
          <div className={styles.home_who__header}>
            <span className={styles.home_who__label}>
              {t("label", { fallback: "WHO" })}
            </span>
          ...
          <div className={styles.home_who__columns}>
            ...
            >
              ...
              {approachItems.map((item) => (
                <div
                  key={item.number}
                  className={styles.home_who__approach_item}
                >
                  ...
                  <span className={styles.home_who__approach_number}>
                    {item.number}
                  </span>
                </div>
              ))}
          ...
          >
            ...
            <div className={styles.home_who__banner_content}>
              ...
              <Button variant="white" type="link" url="/about">
