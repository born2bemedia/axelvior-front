...
const imgBannerBg = '/images/home/whatBannerBg.png';
  ...
  const cards = [
    ...
    },
    {
      ...
      items: [
        ...
        t('card2Item3', {
          fallback: 'Strengthening coherence between skills, pricing, and positioning',
        }),
      ],
      bg: '#1888a2',
      textColor: '#f1f6fd',
    ...
    },
    {
      ...
      items: [
        t('card3Item1', {
          fallback: 'Articulating what makes your work distinct without exaggeration',
        }),
    ...
    },
    {
      ...
      items: [
        t('card4Item1', {
          fallback: 'Structuring workflows, decision logic, and responsibilities',
        }),
        ...
        <div className={styles.home_what__inner}>
          ...
          >
            ...
            <p>
              {t('desc1', {
                fallback:
                  'Axelvior provides business development solutions focused on structure, positioning, and decision-making — where clarity has the highest leverage.',
              })}
            </p>
            <p>
              {t('desc2', {
                fallback:
                  'Our work is designed to reduce friction, sharpen intent, and turn effort into something that holds under pressure.',
              })}
            </p>
          </motion.div>
          ...
          <div className={styles.home_what__solutions}>
            <p className={styles.home_what__solutions_title}>
              {t('solutionsTitle', { fallback: 'Our solutions typically include:' })}
            </p>
          ...
          >
            ...
            <img src={imgBannerBg} alt="" className={styles.home_what__banner_bg} />
            <div className={styles.home_what__banner_overlay} />
            <div className={styles.home_what__banner_box}>
              <p>
                {t('bannerText1', {
                  fallback:
                    "We don't introduce complexity for the sake of sophistication. We remove unnecessary complexity so progress becomes repeatable.",
                })}
              </p>
              <p>
                {t('bannerText2', {
                  fallback:
                    'Every engagement starts with understanding how things actually work now — not how they are supposed to look in theory.',
                })}
              </p>
              <Link href="/what" className={styles.home_what__banner_btn}>
